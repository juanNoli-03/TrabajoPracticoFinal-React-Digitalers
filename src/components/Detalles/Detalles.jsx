    ...
    return (
        <main className='detallesContainer'>
            <section className='detalles'>
                <h1>Apple <img src="/image/apple.png" alt="" /></h1>
            ...
            <section className='detalles'>
                <h1>Huawei <img src="/image/huawei.png" alt="" /></h1>
            ...
            <section className='detalles'>
                <h1>Samsung <img src="/image/samsung.png" alt="" /></h1>
            ...
            <section className='detalles'>
                <h1>Xiaomi <img src="/image/xiaomi.png" alt="" /></h1>
